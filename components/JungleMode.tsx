...
const JungleMode: React.FC<JungleModeProps> = ({ onClose }) => {
  ...
  useEffect(() => {
    // Som Ambiente de Floresta
    const audioUrl = "https://www.myinstants.com/media/sounds/forest-birds-ambience.mp3"; 
    
    audioRef.current = new Audio(audioUrl);
    audioRef.current.volume = 0.5;
    audioRef.current.loop = true;
    audioRef.current.play().catch(e => console.error("Jungle audio failed", e));
